...
parser.add_argument('--dep_dim', type=int, default=50, help='GCN output dim')
...
parser.add_argument('--gcn_layers', type=int, default=3, help='Num of pos GCN layers.')
parser.add_argument('--input_dropout', type=float, default=0.1, help='Input dropout rate.')
parser.add_argument('--margin', type=float, default=0.0, help='margin of negetive')
