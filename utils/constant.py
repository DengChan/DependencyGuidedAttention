...
DEPREL_TO_ID = {PAD_TOKEN: 0, UNK_TOKEN: 1, SAME_TOKEN_DEP: 2, SELF_DEP: 3,
                'dep': 2, 'aux': 3, 'auxpass': 4, 'cop': 5, 'ccomp': 6, 'xcomp': 6, 'mark': 6, 'compound': 6, 'compound:prt': 6, 'dobj': 7, 'iobj': 8, 'punct': 9, 'nsubj': 10, 'nsubjpass': 11, 'csubj': 12, 'csubjpass': 13, 'cc': 14, 'cc:preconj': 14, 'conj': 15, 'expl': 16, 'amod': 17, 'appos': 17, 'advcl': 17, 'det': 17, 'advmod': 17, 'neg': 17, 'nmod': 17, 'nmod:poss': 17, 'nummod': 17, 'nmod:tmod': 17, 'nmod:npmod': 17, 'det:predet': 17, 'parataxis': 18, 'case': 19, 'ROOT': 20, 'root': 20, 'acl:relcl': 21, 'acl': 21, 'mwe': 22, 'discourse': 23}
...
ADDITIONAL_WORDS=["SUBJ-ORGANIZATION", "SUBJ-PERSON", "OBJ-PERSON", "OBJ-ORGANIZATION", "OBJ-DATE", "OBJ-NUMBER",
                  "OBJ-TITLE", "OBJ-COUNTRY", "OBJ-LOCATION", "OBJ-CITY", "OBJ-MISC", "OBJ-STATE_OR_PROVINCE",
